...
Создать **промышленный фреймворк уровня LSP/pyright** для анализа архитектуры кода, оптимизированный для LLM, с интерактивным просмотром, мультиязычной поддержкой и встроенными DevTools.
