...
class CLIUtils:
    ...
    def read_file_content(self, file_path: str, max_size: int = 1024 * 1024) -> Optional[str]:
        ...
        try:
            ...
            if file_stat.st_size > max_size:
                logging.warning(f"File {full_path} is too large ({file_stat.st_size} bytes), skipping")
                return None
    ...
    def get_directory_structure(self, path: str, gitignore_patterns: List[str], 
                ...
                structure = [
                    {
                        ...
                        "type": "directory" if os.path.isdir(os.path.join(full_path, item)) else "file"
                    }
